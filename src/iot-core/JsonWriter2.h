#ifndef IOT_CORE_JSONWRITER2_H_
#define IOT_CORE_JSONWRITER2_H_
...
public:
  JsonWriter2(Output& output) : _output(output) {}
...
template<typename Output>
JsonWriter2<Output> makeJsonWriter2(Output& output) { return {output}; }
